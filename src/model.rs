...
fn adapt_image<B: Backend>(
    device: &B::Device, image: image::ImageBuffer<image::Rgb<u8>, Vec<u8>>
) -> Tensor<B, 4> {
...
fn detect<B: Backend + VisionBackend>(device: &B::Device, model_output: Tensor<B, 3>) -> Vec<Detection> {
